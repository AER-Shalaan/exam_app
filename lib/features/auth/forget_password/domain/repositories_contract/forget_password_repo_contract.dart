...
abstract interface class ForgetPasswordRepositoryContract {
  Future<BaseResponse<ForgetPasswordEntity>> sendEmail({required ForgetPasswordRequestModel body});
  Future<BaseResponse<VerifyResetCodeEntity>> verifyReset({required VerifyResetCodeRequestModel body});
  Future<BaseResponse<AuthResponseEntity>> resetPassword({required ResetPasswordRequestModel body});
}