...
part of 'question_api_client.dart';
...
class _QuestionApiClient implements QuestionApiClient {
  ...
  @override
  Future<List<String>> getAllQuestiononExam(String token, String examId) async {
  ...
  @override
  Future<List<String>> getAllQuestion(String token) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<List<String>> getSingleQuestion(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<List<String>> getUserHistory(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
